...
public class DefaultHospital implements HospitalUseCase {
    ...
    public Hospital getHospitalById(String id) {
        return hospitalPersistent.getHospitalByCriteria(HospitalCriteria.builder().id(id).build());
    }
    ...
    public Hospital createHospital(Hospital hospital) {
        ...
        Hospital saved = hospitalPersistent.getHospitalByCriteria(
                HospitalCriteria.builder().name(hospital.getName()).location(hospital.getLocation()).build()
        );
    ...
    public Hospital updateHospital(Hospital hospital) {
        ...
        Hospital saved = hospitalPersistent.getHospitalByCriteria(HospitalCriteria.builder().id(hospital.getId()).build());
